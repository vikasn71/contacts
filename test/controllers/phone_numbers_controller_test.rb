...
class PhoneNumbersControllerTest < ActionController::TestCase
  ...
  test "should create phone_number" do
    assert_difference('PhoneNumber.count') do
      post :create, phone_number: { name: @phone_number.name, notes: @phone_number.notes, number: @phone_number.number, user_id: @phone_number.user_id }
    end
  ...
  test "should update phone_number" do
    patch :update, id: @phone_number, phone_number: { name: @phone_number.name, notes: @phone_number.notes, number: @phone_number.number, user_id: @phone_number.user_id }
    assert_redirected_to phone_number_path(assigns(:phone_number))
  end
